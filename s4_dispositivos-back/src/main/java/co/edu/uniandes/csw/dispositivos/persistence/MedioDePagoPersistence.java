...
public class MedioDePagoPersistence {
    ...
    public MedioDePagoEntity findByNumeroTarjeta(String pNumeroTarjeta) {
        LOGGER.log(Level.INFO, "Consultando medio de pago por numero de tarjeta %s", pNumeroTarjeta);
        ...
        LOGGER.log(Level.INFO, "Saliendo de consultar un medio de pago por el numero de tarjeta %s", pNumeroTarjeta);
        return result;
    }
}
