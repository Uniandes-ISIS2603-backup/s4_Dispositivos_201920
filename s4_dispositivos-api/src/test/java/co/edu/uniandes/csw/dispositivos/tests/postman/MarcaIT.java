...
public class MarcaIT {
            ...
            private static final String COLLECTION = "Marca_Test.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s4_dispositivos-api.war")//War del modulo api
                ...
                .addPackage(MarcaDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
